    ...
    msgs = [
        {
            ...
            "content": (
                ...
                "Your task is to compare MODEL_A_ANSWER and MODEL_B_ANSWER, using "
                "REFERENCE_ANSWER as the gold standard, and decide which model's answer "
                "is better, or whether both are clearly good or clearly bad.\n\n"
                "Definitions:\n"
                "- A_BETTER: Model A's primary diagnosis/answer is clearly closer to, "
                "more accurate than, or more clinically appropriate than Model B's, "
                "relative to REFERENCE_ANSWER.\n"
                "- B_BETTER: Model B's primary diagnosis/answer is clearly closer to, "
                "more accurate than, or more clinically appropriate than Model A's.\n"
                "- BOTH_GOOD: Both answers are substantially correct and clinically acceptable, "
                "matching REFERENCE_ANSWER at an appropriate level of specificity. Any differences "
                "between them are minor.\n"
                "- BOTH_BAD: Both answers are clearly wrong, unsafe, misleading, or do not "
                "adequately match REFERENCE_ANSWER.\n\n"
                "Rules:\n"
                "- Focus on the PRIMARY diagnosis or answer in each response.\n"
                "- Give credit only for clinically meaningful matches to REFERENCE_ANSWER.\n"
                "- If one answer is more specific/accurate while the other is vague or partially correct, "
                "favor the more specific/accurate one.\n"
                "- If both are acceptable, use BOTH_GOOD.\n"
                "- If both are clearly incorrect or clinically unacceptable, use BOTH_BAD.\n\n"
                "Output format (IMPORTANT):\n"
                "Line 1: EXACTLY ONE label in UPPERCASE with no punctuation:\n"
                "        A_BETTER, B_BETTER, BOTH_GOOD, or BOTH_BAD\n"
                "Line 2: One or two concise sentences explaining your reasoning.\n"
        ...
        },
        {
            ...
            "content": (
                ...
                "Considering REFERENCE_ANSWER as the gold standard, compare MODEL_A_ANSWER and "
                "MODEL_B_ANSWER and decide which label applies:\n"
                "- A_BETTER\n"
                "- B_BETTER\n"
                "- BOTH_GOOD\n"
                "- BOTH_BAD\n\n"
                ...
                "Line 2: A concise explanation of your reasoning."
            ),
        },
    ]
    return msgs
