"""Judge prompts for management_reasoning diagnosis eval.

Mirrored from ``open_eval/llm/prompts.py`` so this track does not edit open_eval.
Keep wording in sync deliberately when changing either copy.
"""
...
- MODEL_ANSWER: the model response
