...
# ============================================================
# Semantic matcher with cache (batch)
# ============================================================
...
def parse_args():
    ...
    ap.add_argument("--pxhx_path", type=str, required=True,
                    help="Merged ground-truth JSON array (each item has ground_truth_space_majority).")
    ap.add_argument("--output_path", type=str, required=True,
                    help="Where to save metrics JSON.")
    ap.add_argument("--col_name", type=str, required=True,
                    help="Column name for target response (e.g., 'original_output' or 'model_response').")
...
def main():
    ...
    truth = load_json_array(args.pxhx_path)  # merged truth array
